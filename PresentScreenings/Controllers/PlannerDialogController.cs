...
namespace PresentScreenings.TableView
{
	public partial class PlannerDialogController : NSViewController
	{
        ...
        const float _controlsWidth = ControlsFactory.StandardButtonWidth;
        ...
        NSScrollView _filmsScrollView;
        NSTextField _filmsDocumentView;
        #endregion
        ...
        void PlanScreenings(NSObject sender)
        {
        ...
        void ClosePlanView(NSObject sender)
        {
            CloseDialog();
        }
        #endregion
